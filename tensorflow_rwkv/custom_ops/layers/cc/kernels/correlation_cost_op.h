...
#ifndef tensorflow_rwkv_LAYERS_KERNELS_CORRELATION_COST_OP_H_
#define tensorflow_rwkv_LAYERS_KERNELS_CORRELATION_COST_OP_H_
...
#endif  // tensorflow_rwkv_LAYERS_KERNELS_CORRELATION_COST_OP_H_
